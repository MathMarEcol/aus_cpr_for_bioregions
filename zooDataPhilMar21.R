...
BGCSamp <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/BGC_Trip.csv", na = "") %>%
...
getBGCZooData <- function(){
  BGCZdat <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/BGC_Zoop_Raw.csv", na = "") %>%
...
# Bring in Change Log
nrsZcl <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/BGC_Zoop_ChangeLog.csv", na = "") %>%
...
cprZsamp <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/CPR_Samp.csv", na = "") %>%
  dplyr::filter( grepl("Z", SAMPLETYPE)) %>%
...
cprZdat <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/CPR_Zoop_Raw.csv", na = "") %>%
  rename(Sample = SAMPLE, TaxonName = TAXON_NAME, Copepod = COPEPOD, TaxonGroup = TAXON_GROUP,
         Genus = GENUS, Species = SPECIES, ZAbund_m3 = ZOOP_ABUNDANCE_M3)

# Bring in Change Log
cprZcl <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/CPR_Zoop_ChangeLog.csv", na = "") %>%
  rename(TaxonName = TAXON_NAME, StartDate = STARTDATE, ParentName = PARENT_NAME)
