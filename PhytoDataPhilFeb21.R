...
BGCPsamp <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/BGC_Trip.csv", na = "") %>%
...
BGCPdat <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/BGC_Phyto_Raw.csv", na = "") %>%
...
# Bring in Change Log
BGCPcl <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/BGC_Phyto_ChangeLog.csv", na = "", col_select = 1:3) %>%
...
cprPsamp <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/CPR_Samp.csv", na = "") %>%
  dplyr::filter( grepl("P", SAMPLETYPE)) %>%
...
# Bring in plankton data
cprPdat <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/CPR_Phyto_Raw.csv", na = "") %>%
...
# Bring in Change Log
cprPcl <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/tree/cfc7ad6a6e51b2f6f6c24b5106274be4a4031f98/Plankton/RawData/CPR_Phyto_ChangeLog.csv", na = "") %>%
  rename(TaxonName = TAXON_NAME, StartDate = STARTDATE, ParentName = PARENT_NAME)
