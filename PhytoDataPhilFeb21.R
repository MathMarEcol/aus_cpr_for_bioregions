...
BGCPdat <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/master/Plankton/RawData/BGC_Phyto_Raw.csv", na = "") %>%
...
cprPsamp <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/master/Plankton/RawData/CPR_Samp.csv", na = "") %>%
  dplyr::filter( grepl("P", SAMPLETYPE)) %>%
...
# Bring in plankton data
cprPdat <- read_csv("https://raw.githubusercontent.com/PlanktonTeam/IMOS_Toolbox/master/Plankton/RawData/CPR_Phyto_Raw.csv", na = "") %>%
